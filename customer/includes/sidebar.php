<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="<?php if($page=='payment'){ echo 'active'; }?>"><a href="https://ug2002033.cse.pstu.ac.bd/customer/payment.php"><i class="icon icon-money"></i> <span>Payment</span></a></li>
    <li class="<?php if($page=='download'){ echo 'active'; }?>"><a href="https://ug2002033.cse.pstu.ac.bd/customer/download.php"><i class="icon icon-download"></i> <span>Download</span></a></li>
  </ul>
</div>